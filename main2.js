...
$(document).ready(function () {
    ...
    // Handler for #PaywithPaystack on Delivary click event
    $("body").delegate("#paystackPayAtDelivery", "click", function () {
        var delM = $('#delM').val();
        var address = $('#address').val();
        var addressInput = $('#addressInput');
...
// Function to process data and post to action2.php
function PaystackPayAtDelivery() {
    // Retained pre-commented sections
    /*
    var address = $('#address').val();
    var addressInput = $('#addressInput');
