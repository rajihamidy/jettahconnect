...
if (isset($_POST['email']) && isset($_POST['recovery_code']) && isset($_POST['new_password']) && isset($_POST['cnew_password'])) {
    ...
    $recovery_code = mysqli_real_escape_string($conn, $_POST['recovery_code']);
    $new_password = mysqli_real_escape_string($conn, $_POST['new_password']);
    $cnew_password = mysqli_real_escape_string($conn, $_POST['cnew_password']);
    ...
    $sql = "SELECT recovery_code, recovery_expiration FROM admin WHERE email = '$email'";
    ...
    if ($row) {
        ...
        if ($recovery_code === $stored_recovery_code && strtotime($recovery_expiration) > time()) {
            $update_sql = "UPDATE admin SET password = '$hashed_password', recovery_code = NULL, recovery_expiration = NULL WHERE email = '$email'";
