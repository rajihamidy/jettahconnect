...
class Customers
{
	...
	public function getCustomersOrder(){
		...
		$query = $this->con->query("SELECT o.order_id, o.product_id, o.qty,o.user_id, o.trx_id, o.seller_id, o.orderdate,o.deliveryStatus, o.p_status,o.payMethod, p.product_title, p.product_image, u.first_name, u.last_name,u.email,u.mobile,u.address1,u.address2 FROM orders o 
		JOIN products p ON o.product_id = p.product_id
		INNER JOIN user_info u ON o.user_id = u.user_id
		 where seller_id='$admin_id' order by orderdate desc");
		$ar = []; 
		if (@$query->num_rows > 0) {
